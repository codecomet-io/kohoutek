...
export default async function Pantry(buffer, trace, meta) {
    ...
    const buildRun = buffIngester.ingest(trace);
    ...
    for (const [digest, traceObject] of Object.entries(buildRun.actionsObject)) {
        ...
        if (buildActionsObject[digest]) {
            ...
            for (const key of Object.keys(buildActionsObject)) {
                if (((_a = buildActionsObject[key]) === null || _a === void 0 ? void 0 : _a.name) === ((_b = buildRun.actionsObject[digest]) === null || _b === void 0 ? void 0 : _b.name)) {
    ...
    const actionsOrder = Object.keys(buildRun.actionsObject)
        .sort((a, b) => // sort values chronologically, based on start time
     { var _a, _b; // sort values chronologically, based on start time
    return ((_a = buildRun.actionsObject[a]) === null || _a === void 0 ? void 0 : _a.started) - ((_b = buildRun.actionsObject[b]) === null || _b === void 0 ? void 0 : _b.started); });
    ...
    outermostLoop: while (true) {
        for (const key of actionsOrder) {
            const parents = (_c = buildRun.actionsObject[key]) === null || _c === void 0 ? void 0 : _c.buildParents;
    ...
    const actions = [];
    for (const key of actionsOrder) {
        const item = buildRun.actionsObject[key];
    ...
    return Object.assign(Object.assign({}, buildRun), { timingInfo,
        filesets,
        actions });
}
