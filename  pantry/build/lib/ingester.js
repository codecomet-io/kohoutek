...
class Build {
    constructor() {
        this.id = "abcd1234";
        this.name = "user-defined name for this run";
        this.pipelineId = "unique-pipeline-identifier";
        this.pipelineName = "user-defined name for the pipeline";
        this.description = "This is our super test plan, and guess what this description can change at any time";
        this.started = 0;
        this.completed = 0;
        this.status = model.RunStatus.Completed;
        this.runtime = 0;
        this.machineTime = 0;
        this.trigger = "manual";
        this.actionsObject = {};
